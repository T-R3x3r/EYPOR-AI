...
base_scenario_db = 'scenario_20250710_210837_098/database.db'
scenario1_db = 'scenario_20250710_210837_120/database.db'
...
scenario1_data = fetch_data(scenario1_db, query_birmingham_demand)
